    ...
    public void run() {
        try {
            while (true) {
                ...
                messages += "I received the request: " + request;
                if (request.startsWith("send")) {
                    ...
                    else {out.println("No message to send"); messages += "No message to send";}
                }
                ...
                else if(request.startsWith("register"))
                {
                    ...
                    else {out.println("register with a name");messages += "register with a name";}
                ...
                {
                    Read read = new Read();
                    read.readCommand(out);

                }
                {
                    out.println("enter a valid command");
                    messages += "enter a valid command";
                }
            }
